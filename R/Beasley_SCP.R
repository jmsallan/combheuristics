...
#' 
#' @description A list containing 80 instances of the set covering problem included in the OR-Library maintained by J. R. Beasley.
#' 
#' @format A list containing 80 lists, named as in the original problem set. Each list has the following contents:
#' \describe{
